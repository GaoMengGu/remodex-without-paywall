...
private extension CodexService {
    var threadForkBridgeUpdatePrompt: CodexBridgeUpdatePrompt {
        CodexBridgeUpdatePrompt(
            title: "Update Codex Anywhere on your device to use /fork",
            message: "This device bridge does not support native conversation forks yet. Update the Codex Anywhere npm package to use /fork and worktree fork flows.",
