...
private extension CodexService {
    var serviceTierBridgeUpdatePrompt: CodexBridgeUpdatePrompt {
        CodexBridgeUpdatePrompt(
            title: "Update Codex Anywhere on your device to use Speed controls",
            message: "This device bridge does not support the selected speed setting yet. Update the Codex Anywhere npm package to use Fast Mode and other speed controls.",
