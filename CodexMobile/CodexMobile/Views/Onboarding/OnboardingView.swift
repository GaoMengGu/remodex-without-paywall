...
struct OnboardingView: View {
    ...
    var body: some View {
            ...
            VStack(spacing: 0) {
                TabView(selection: $currentPage) {
                    ...
                    OnboardingStepPage(
                        ...
                        description: "The AI coding agent that lives in your terminal. Codex Anywhere connects to it from your iPhone.",
                    ...
                    OnboardingStepPage(
                        ...
                        commandCaption: "Codex Anywhere can keep your device awake with macOS caffeinate while the bridge is running, but it starts disabled by default. You can enable it later in Settings if you want."
                    )
                    .tag(3)
        ...
        .alert("Install Codex CLI First", isPresented: $isShowingCodexInstallReminder) {
            ...
            Text("Copy and paste \"\(codexInstallCommand)\" on your device before moving on. Codex Anywhere will not work until Codex CLI is installed and available in your PATH.")
        }
    }
