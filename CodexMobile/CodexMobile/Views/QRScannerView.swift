...
struct QRScannerView: View {
            ...
            VStack(alignment: .leading, spacing: 24) {
                ...
                VStack(alignment: .leading, spacing: 14) {
                    if let command = prompt.command, !command.isEmpty {
                        ...
                        bridgeUpdateStep(number: "1", title: "Update Codex Anywhere", detail: command, showsCopyButton: true)
                        ...
                        bridgeUpdateStep(number: "1", title: "Update Codex Anywhere", detail: "Install the latest Codex Anywhere build on this iPhone.")
    ...
    private var scannerOverlay: some View {
        VStack(spacing: 24) {
            ...
            Text("Scan the Codex Anywhere QR code")
...
private extension CodexBridgeUpdatePrompt {
    static let previewScannerMismatch = CodexBridgeUpdatePrompt(
        title: "Update Codex Anywhere on your Mac before scanning",
        message: "This QR code was generated by a different Codex Anywhere npm version. Update the package on your Mac to the latest release before scanning a new QR code.",
